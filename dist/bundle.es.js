...
const DEFAULT_ROMANIAN_KNOWN_TAGS = ['afectiuni', 'alegeri', 'america', 'anarhie', 'anglia', 'animale', 'animatii', 'antrenament', 'ape', 'arena', 'armata', 'arme', 'arta', 'aventura', 'avocati', 'baieti', 'bancuri', 'barbati', 'batalii', 'beletristica', 'benzi desenate', 'biciclete', 'biserica', 'boli', 'bolnavi', 'box', 'bulgaria', 'bursa', 'cadouri', 'calatorii', 'calm', 'carti', 'cenzura', 'clipuri', 'comedie', 'concursuri', 'conspiratii', 'constiinta', 'copii', 'cosmetica', 'credinta', 'criptomonede', 'cumparaturi', 'cupluri', 'cure', 'curent', 'cursuri', 'cutremur', 'dans', 'desene animate', 'diaspora', 'diete', 'dinozauri', 'divertisment', 'doctori', 'documentar', 'drivere', 'droguri', 'drumetii','economie', 'editare', 'educatie', 'electricitate', 'elevi', 'emigranti', 'emisiuni tv', 'enciclopedie', 'evaluari', 'excursii', 'exercitii', 'explorare', 'extraterestri', 'fabule', 'familie', 'fantome', 'farse', 'femei', 'fete', 'fictiune', 'filme', 'flori', 'fluvii', 'fotbal', 'fotografii', 'franta', 'fumat', 'fumatori', 'gafe', 'germania', 'gimnastica', 'gladiatori', 'glume', 'gradinita', 'grafica', 'groaza', 'homeopatie', 'hoti', 'idioti', 'impresii', 'indragostiti', 'insecte', 'insula', 'invatare', 'invatatori', 'irlanda', 'istorie', 'italia', 'jandarmi', 'jocuri gratuite', 'jocuri', 'jucarii', 'limbi straine', 'lumina', 'luna', 'luptatori', 'machiaj', 'mafie', 'mafioti', 'magie', 'mancare', 'manuale', 'masini', 'medicina', 'meditatii', 'militari', 'minerale', 'miscare', 'motociclete', 'munti', 'muzica', 'natura', 'naturiste', 'noutati', 'oceane', 'ochelari', 'olanda', 'pace', 'pamant', 'parinti', 'pasari', 'pescari', 'pescuit', 'pesti', 'piele', 'planete', 'poante', 'poezie', 'politica', 'politie', 'poze', 'preoti', 'presedinte', 'prezentari', 'profesori', 'programare', 'programatori', 'programe', 'prosti', 'proteste', 'psihologie', 'rauri', 'razboinici', 'recenzii', 'regim', 'resurse naturale', 'retete', 'revolte', 'ring', 'romana', 'rusia', 'sanatate', 'scoala', 'scotia', 'sfinti', 'slabit', 'soare', 'spania', 'spargeri', 'spiritualitate', 'sport', 'stiinta', 'stiri false', 'stiri', 'sunete', 'tehnologie', 'traducatori', 'traduceri', 'trailer', 'turism', 'tutoriale', 'umor', 'ungaria', 'univers', 'utilitare', 'vacanta', 'vanatoare', 'vanatori', 'versuri', 'virusi', 'zacaminte', 'zei'];

const DEFAULT_KNOWN_TAGS = [...DEFAULT_ENGLISH_KNOWN_TAGS, ...DEFAULT_SPANISH_KNOWN_TAGS, ...DEFAULT_ROMANIAN_KNOWN_TAGS];
